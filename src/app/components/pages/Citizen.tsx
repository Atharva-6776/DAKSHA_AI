...
export const Citizen = () => {
  ...
  return (
    <div style={{ width: "100%", minHeight: "80vh", display: "flex", alignItems: "stretch" }}>
      ...
      {/* Right panel */}
      <div style={{ flex: 1, padding: "60px", background: C.darker, display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                {[
                  ...
                  <div key={i}
                    ...
                    onMouseEnter={e => { e.currentTarget.style.borderColor = C.yellow; e.currentTarget.style.background = "rgba(254,218,106,0.04)"; }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(57,63,77,0.6)"; e.currentTarget.style.background = "rgba(29,30,34,0.5)"; }}>
                    {i === 1 && (
              ...
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/9", background: "#000", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", bottom: 24, left: "50%", transform: "translateX(-50%)" }}>
                  <button onClick={handleCapture}
                    style={{ width: 60, height: 60, borderRadius: "50%", background: C.yellow, border: `3px solid rgba(254,218,106,0.3)`, cursor: "pointer", boxShadow: `0 0 24px rgba(254,218,106,0.4)`, transition: "all 0.2s" }}
            ...
            <motion.div key="preview"
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "14px 18px", border: `1px solid rgba(57,63,77,0.5)`, background: "rgba(29,30,34,0.6)", marginBottom: 28 }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 13, color: "rgba(212,212,220,0.6)", wordBreak: "break-all" }}>
                    {locationLoading ? "Please wait..." : locationInfo?.label ?? "Unknown"}
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button onClick={() => setMode("select")} disabled={isUploading}
                  style={{ flex: 1, padding: "15px", background: "transparent", border: `1px solid rgba(57,63,77,0.6)`, color: C.silver, fontFamily: "'Rajdhani', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", fontWeight: 600, cursor: "pointer", transition: "all 0.3s" }}>
                  Retake
                </button>
                <button onClick={handleSubmit} disabled={isUploading || locationLoading}
                  style={{ flex: 2, padding: "15px", background: isUploading || locationLoading ? C.grey : C.yellow, border: "none", color: C.dark, fontFamily: "'Rajdhani', sans-serif", fontSize: 11, letterSpacing: "0.3em", textTransform: "uppercase", fontWeight: 700, cursor: "pointer", transition: "all 0.3s", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                  {isUploading ? (
