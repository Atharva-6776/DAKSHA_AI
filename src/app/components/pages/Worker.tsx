          ...
          {mode === "camera" && report && (
            <motion.div key="camera" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.5 }}>
              ...
              <div style={{ margin: "16px 0", display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", border: `1px solid rgba(57,63,77,0.5)` }}>
                {gps.status === "requesting" && <><Loader2 size={13} style={{ color: C.yellow }} /><span style={{ ...S.body, fontSize: 13 }}>Acquiring GPS…</span></>}
              ...
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/9", background: "#000", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", top: 12, left: 12, display: "flex", alignItems: "center", gap: 6, padding: "6px 12px", background: "rgba(0,0,0,0.7)" }}>
                  <div style={{ width: 6, height: 6, borderRadius: "50%", background: C.yellow }} />
                ...
                <div style={{ position: "absolute", top: 12, right: 12, padding: "6px 12px", background: "rgba(0,0,0,0.7)" }}>
